...
- (void)initSubviews
{
    ...
    [_cancelButton setImage:[UIImage imageNamed:@"btn_cancel@2x"] forState:UIControlStateNormal];
    ...
    [_cameraButton setImage:[UIImage imageNamed:@"btn_camera@2x"] forState:UIControlStateNormal];
    ...
    [_dvButton setImage:[UIImage imageNamed:@"btn_video@2x"] forState:UIControlStateNormal];
    ...
    [_photoBrowserSendButton setImage:[UIImage imageNamed:@"icon_ashbin@2x"] forState:UIControlStateNormal];
    ...
    [_cameraCancelButton setImage:[UIImage imageNamed:@"btn_cancel@2x"] forState:UIControlStateNormal];
    ...
    [_cameraFlashButton setImage:[UIImage imageNamed:@"btn_thunder_off@2x"] forState:UIControlStateNormal];
    ...
    [_cameraSwitchButton setImage:[UIImage imageNamed:@"btn_photo@2x"] forState:UIControlStateNormal];
    ...
    [_cameraSnapButton setImage:[UIImage imageNamed:@"btn_shoot@2x"] forState:UIControlStateNormal];
